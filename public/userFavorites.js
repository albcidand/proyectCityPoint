...
a la tabla de favoritos de la base de datos (en la vista de favoritos del usuario) y además actualiza la vista utilizando peticiones ajax */
...
$(document).on('click', '#btn_confirm_alert', function () {
    ...
    /* si se hace click sobre el botón de aceptar de la alerta se hace otra petición ajax (FavoriteListController.php) que elimina el lugar
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#places').html(''); /* vaciamos el contenedor de los lugares favoritos para poder llenarlo de nuevo con la información actualizada después de haber eliminado el lugar */
