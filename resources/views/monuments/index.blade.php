    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <section id="title">
                ...
                <div>
                    <p class="filterSectionTitle"><span class="mark">Monument</span> Places</p>
                    <a id="backBtn" href="/home"><i class="uil uil-arrow-left"></i><p>Go Back</p></a>
                </div>
                <p class="muted">A selection of monuments from cities all around the world</p>
            ...
            <section id="places" class="responsive_cards">
                ...
                <!-- recibimos los datos del back (CategoriesController.php) y usamos un bucle forEach para recorrerlos, de esta forma por cada uno de los lugares creamos un elemento "card" que mostrará en pantalla los datos del lugar -->

                            <div class="card">
                                <button class="fav_btn" value="{{$monument -> place_id}}"><i class="uil uil-heart likeHeart"></i></button><!-- pasamos la id del lugar al value del botón de favoritos, de esta forma podemos usarlo para identificar el lugar cuando se hace click sobre el botón -->
